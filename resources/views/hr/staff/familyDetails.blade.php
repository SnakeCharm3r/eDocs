    ...
    <div class="content container-fluid" style="background-color: #eff8f3;">
                ...
                <div class="col-sm-12">
                    <div class="page-sub-header d-flex justify-content-between align-items-center">
                        <h3 class="page-title mb-0">
                            <i class="fas fa-users me-2"></i>Family Details - {{ $user->fname }} {{ $user->lname }}
                        </h3>
        ...
        <div class="container my-5">
            <div class="alert alert-info mb-4">
                ...
                <strong>HR Mode:</strong> You are adding family details for <strong>{{ $user->fname }} {{ $user->lname }}</strong>.
                <br><small>Please enter details about immediate family members (e.g., parents, siblings, spouse, children).</small>
            </div>
                            ...
                            <div class="col mb-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('hr.employee.save-family-details', $user->id) }}">
                                            @csrf
                                            ...
                                            @php
                                                $nextOfKinExists = $familyData ? $familyData->contains('next_of_kin', true) : false;
                                            @endphp
                                            ...
                                            <div class="d-flex gap-2 mt-3">
                                                <button type="submit"
                                                    class="btn btn-primary">{{ isset($familyMember) ? 'Save' : 'Add' }}</button>
                                                <a href="{{ route('employees_details.show', $user->id) }}" 
