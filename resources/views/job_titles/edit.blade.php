            ...
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title mb-0">
                        <i class="fas fa-edit me-2 text-success"></i>Edit Job Title
                    </h3>
                    <p class="text-muted mb-0 mt-1">Update job title information</p>
                </div>
                <div class="col-auto">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white border-bottom">
                        <h5 class="mb-0 fw-semibold">
                            <i class="fas fa-briefcase me-2 text-success"></i>Job Title Details
                        </h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('job_titles.update', $jobTitle) }}" method="POST" id="editJobTitleForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" 
                                    ...
                                    id="job_title" 
                                    name="job_title"
                                    value="{{ old('job_title', $jobTitle->job_title) }}" 
                                ...
                                <select class="form-select @error('deptId') is-invalid @enderror" 
                                    ...
                                    @foreach ($departments as $department)
                                        <option value="{{ $department->id }}"
                                            {{ old('deptId', $jobTitle->deptId) == $department->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select @error('clinical_or_non_clinical') is-invalid @enderror" 
                                    ...
                                    <option value="Clinical" {{ old('clinical_or_non_clinical', $jobTitle->clinical_or_non_clinical) == 'Clinical' ? 'selected' : '' }}>Clinical</option>
                                    <option value="Non-Clinical" {{ old('clinical_or_non_clinical', $jobTitle->clinical_or_non_clinical) == 'Non-Clinical' ? 'selected' : '' }}>Non-Clinical</option>
                                </select>
                            ...
                            <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                ...
                                <button type="submit" class="btn btn-success">
                                    <i class="fas fa-save me-1"></i> Update Job Title
                                </button>
                            </div>
                        </form>
                    </div>
