...
<head>
    ...
    <title>Employee Clearance Form Approval Request</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        <div class="header">
            <h1>📋 Employee Clearance Form - {{ $stepName }} Approval Required</h1>
        </div>
        ...
        <div class="content">
            @php
                ...
                $submissionDate = optional($clearanceForm->created_at)->timezone('Africa/Dar_es_Salaam')->format('d M Y, H:i');
            @endphp
            ...
            <div class="alert-banner">
                <strong>🔔 Employee Clearance Form Requires Your Approval</strong>
                <span>Please review and approve the clearance form for {{ $submitterName }}</span>
            </div>

            <div class="highlight">
                <p style="margin: 0;">
                    <strong>{{ $submitterName }}</strong> has submitted an Employee Clearance Form that requires your approval as <strong>{{ $stepName }}</strong>.
                </p>
            </div>

            <div class="info-card">
                <h3>Clearance Form Details</h3>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value" style="color: #007A33; font-weight: 600;">{{ $stepName }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Status:</span>
                    <span class="info-value" style="color: #ffc107; font-weight: 600;">
                        {{ $workflow->work_flow_status ?? 'Pending Approval' }}
                    </span>
                </div>
            </div>

            <div class="urgency-note">
                <strong>⏱️ Action Required:</strong> This clearance form is pending your approval. Please review all sections relevant to your department and take appropriate action.
            </div>

            <div class="button-container">
                <a href="{{ $approvalUrl }}" class="action-button" target="_blank">
                    👉 Review & Approve Clearance Form
                </a>
            </div>
