...
<body>
    ...
    <div class="container">
        ...
        {{-- <div class="header">
            ...
            <h2>e-Docs - HR Form Rejection</h2>
        </div> --}}
        ...
        <div class="content">
            ...
            <p>We regret to inform you that your HR form submission has been rejected in the e-Docs system.</p>
            ...
            <p>{{ $rejectionReason }}</p>
            <p><a href="http://192.168.2.93/" target="_blank">Click here to go to login</a></p>
