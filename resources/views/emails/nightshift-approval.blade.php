...
<head>
    ...
    <title>Night Allowance Claim Approval Request</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        <div class="header">
            <h1>🌙 Night Allowance Approval Request</h1>
        </div>
        ...
        <div class="content">
            @php
                ...
                $submissionDate = optional($nightShiftClaim->created_at)->timezone('Africa/Dar_es_Salaam')->format('d M Y, H:i');
            ...
            <div class="highlight">
                <p style="margin: 0;">
                    <strong>{{ $submitterName }}</strong> has submitted a night allowance claim that requires your approval.
                </p>
            </div>
