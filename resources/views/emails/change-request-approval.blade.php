...
<head>
    ...
    <title>Change Request Approval Request</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        <div class="header">
            <h1>📋 Change Request Awaiting Approval</h1>
        </div>
        ...
        <div class="content">
            @php
                ...
                $submissionDate = optional($changeRequest->created_at)->timezone('Africa/Dar_es_Salaam')->format('d M Y, H:i');
                $changeTypeLabel = $changeRequest->change_type === 'price' ? 'Price Change' : 'Non-Price Change';
            @endphp
            ...
            <div class="alert-banner">
                <strong>🔔 New Change Request Requires Your Review</strong>
                <span>Please review and take action on this pending request</span>
            </div>

            <div class="highlight">
                <p style="margin: 0;">
                    <strong>{{ $submitterName }}</strong> has submitted a <strong>{{ $changeTypeLabel }}</strong> request
                </p>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">#{{ $changeRequest->id }}</span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $changeTypeLabel }}</span>
                </div>
                @if($changeRequest->change_category)
                <div class="info-row">
                    <span class="info-label">Category:</span>
                    <span class="info-value">{{ $changeRequest->change_category }}</span>
                </div>
                @endif
                <div class="info-row">
                    <span class="info-label">Priority:</span>
                    <span class="info-value">{{ $changeRequest->priority ?? 'N/A' }}</span>
                </div>
                <div class="info-row">
