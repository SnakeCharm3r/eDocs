...
<head>
  ...
  <title>On-Call Claim Submitted</title>
  <style>
    ...
    .status-submitted{background-color:#d1ecf1;color:#0c5460;border-left:4px solid #17a2b8}
...
<body>
  <div class="email-wrapper">
    ...
    <div class="content">
      ...
      <div class="status-banner status-submitted">
        <span class="status-icon">✅</span>
        <strong>Your on-call claim has been successfully submitted for approval</strong>
      </div>
      ...
      <div class="info-card">
        ...
        <div class="info-row">
          ...
          <span class="info-value">{{ optional($onCallRequest->created_at)->timezone('Africa/Dar_es_Salaam')->format('d M Y, H:i') }}</span>
        </div>
        <div class="info-row">
