...
<head>
    ...
    <title>On-Call Claim Approval Request</title>
    <style>
        body {
    ...
    <div class="email-wrapper">
        ...
        <div class="content">
            @php
                ...
                $submissionDate = optional($onCallRequest->created_at)->timezone('Africa/Dar_es_Salaam')->format('d M Y, H:i');
                $year = $onCallRequest->locum_year ?? optional($onCallRequest->created_at)->format('Y');
            @endphp
