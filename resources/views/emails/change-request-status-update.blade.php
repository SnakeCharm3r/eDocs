...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            @php
                $requester = $changeRequest->user ?? null;
            ...
            <div class="status-banner {{ $status === 'approved' ? 'status-approved' : 'status-rejected' }}">
                @if ($status === 'approved')
                    ...
                    <strong>Your change request has been APPROVED{{ $approvalStep ? ' by ' . $approvalStep : '' }}</strong>
                @else
                    <span class="status-icon">❌</span>
                    <strong>Your change request has been REJECTED</strong>
                @endif
            </div>
