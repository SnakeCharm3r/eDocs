        ...
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Add Access Key Card</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('access-key-card.store') }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-success">Save Access Key Card</button>
