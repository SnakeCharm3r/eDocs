                            ...
                            <form action="{{ route('announcements.update', $announcement->id) }}" method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control" required
                                        ...
                                        placeholder="Enter the notice board title">
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="content" id="content" class="form-control" rows="12" required
                                        placeholder="Enter the notice board content">{{ old('content', $announcement->content) }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" name="pdf" id="pdf" class="form-control" accept=".pdf" onchange="validateFile()">
                                    <small id="fileError" class="d-block mt-1 text-danger" style="display: none;"></small>
                                    <small class="form-text text-muted">
                                        Maximum file size: 5MB. Only PDF files are allowed. Leave empty to keep current PDF.
                                    </small>

                                    @if ($announcement->pdf_path)
                                        <div class="mt-2">
                                            <a href="{{ Storage::url($announcement->pdf_path) }}" class="btn btn-success btn-sm"
                                                target="_blank">
...
@section('scripts')
    ...
    <script>
        ...
        function initializeSummernote() {
            ...
            var existingContent = jQuery('#content').val();

            jQuery('#content').summernote({
                height: 400,
                toolbar: enhancedToolbar,
                placeholder: 'Enter the notice board content...',
                popover: {
                    image: [
                ...
                callbacks: {
                    ...
                    onInit: function() {
                        ...
                        if (existingContent) {
                            jQuery('#content').summernote('code', existingContent);
                        }
                    }
                }
            });
