                                        ...
                                        @forelse($paymentTypes as $paymentType)
                                            <div class="col-md-6 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="payment_types[]" value="{{ $paymentType->name }}" id="payment_{{ $paymentType->id }}" {{ in_array($paymentType->name, old('payment_types', [])) ? 'checked' : '' }}>
