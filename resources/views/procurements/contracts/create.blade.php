            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('procurements.contracts.store') }}" method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <small class="form-text text-muted">Select whether this is a new contract or an
                                                existing contract being added to the system</small>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('status') is-invalid @enderror" id="status"
                                                ...
                                                <option value="in_progress"
                                                    {{ old('status', 'in_progress') == 'in_progress' ? 'selected' : '' }}>
                                                    In Progress
                                                </option>
                                            ...
                                            <small class="form-text text-muted">Status will be updated automatically based
                                                on approval workflow</small>
                                            @error('status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('currency') is-invalid @enderror"
                                                ...
                                                <option value="TZS"
                                                    {{ old('currency', 'TZS') == 'TZS' ? 'selected' : '' }}>TZS</option>
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="btn btn-success">
                                        <i class="fas fa-save me-1"></i> Create Contract & Submit for Approval
                                    </button>
                                    <a href="{{ route('procurements.contracts.index') }}" class="btn btn-secondary">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                departmentSelect.addEventListener('change', function() {
                    ...
                    if (departmentId) {
                        const url =
                            `{{ url('/procurements/contracts/departments') }}/${departmentId}/line-manager`;
                        ...
                        fetch(url, {
                            ...
                            .then(data => {
                                ...
                                if (data.success && data.line_manager) {
                                    ...
                                    contractManagerId.value = data.line_manager
                                        .id; // Set as contract manager
                                } else {
