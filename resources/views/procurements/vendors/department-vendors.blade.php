                ...
                <div class="card shadow-sm mb-4 border-0">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h5 class="mb-1">
                                    <i class="fas fa-sitemap me-2 text-success"></i>{{ $department->dept_name }}
                                </h5>
                                <p class="text-muted mb-0">
                                    Vendors with contracts in your department
                                </p>
                            </div>
                            <div class="col-md-4 text-end">
                                <div class="d-flex align-items-center justify-content-end">
                                    <div class="me-3">
                                        <h4 class="mb-0 text-success">{{ $vendors->count() }}</h4>
                                        <small class="text-muted">Total Vendors</small>
                                    </div>
                                    <div>
                                        <h4 class="mb-0 text-primary">{{ $vendors->sum('contracts_count') }}</h4>
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1 text-dark">
                                            <i
                                                class="fas fa-building me-2 text-success"></i>{{ Str::limit($vendor->name, 30) }}
                                        </h6>
                                        @if ($vendor->industry)
                                ...
                                @if ($vendor->contracts->count() > 0)
                                    <div class="mb-3">
                                        ...
                                        <div class="list-group list-group-flush">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <small class="text-muted">
                                                                ...
                                                                @if ($contract->status)
                                                                    | <span
                                                                        class="badge bg-{{ $contract->status == 'active' ? 'success' : 'secondary' }} badge-sm">
                                            ...
                                            @endforeach
                                            @if ($vendor->contracts->count() > 3)
                                                <small class="text-muted px-0">
                                                    +{{ $vendor->contracts->count() - 3 }} more contract(s)
                                                </small>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                @for ($i = 1; $i <= 5; $i++)
                                                    <i
                                                        class="fas fa-star {{ $i <= $latestScore->score_value ? 'text-warning' : 'text-muted' }}"></i>
                                                @endfor
                                                <span
                                                    class="ms-1 small fw-semibold">{{ $latestScore->score_value }}/5</span>
                                            </div>
                                        </div>
                            ...
                            <div class="card-footer bg-white border-top">
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary flex-fill"
                                        data-bs-toggle="modal" data-bs-target="#rateVendorModal{{ $vendor->id }}">
                            ...
                            <div class="modal-content border-0 shadow">
                                ...
                                <form id="rateVendorForm{{ $vendor->id }}" method="POST"
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="rating_type{{ $vendor->id }}"
                                                class="form-label fw-semibold">Rating Type</label>
                                            <select class="form-select" id="rating_type{{ $vendor->id }}"
                                                name="rating_type" required>
                                        ...
                                        <div class="mb-3">
                                            <label for="contract_id{{ $vendor->id }}"
                                                class="form-label fw-semibold">Related Contract (Optional)</label>
                                            <select class="form-select" id="contract_id{{ $vendor->id }}"
                                                name="contract_id">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="rating-input">
                                                @for ($i = 5; $i >= 1; $i--)
                                                    <input type="radio" name="score_value"
                                                        id="star{{ $i }}_{{ $vendor->id }}"
                                                        value="{{ $i }}" required>
                                                    <label for="star{{ $i }}_{{ $vendor->id }}"
                                                        class="star-label">
                                        ...
                                        <div class="mb-3">
                                            <label for="comments{{ $vendor->id }}"
                                                class="form-label fw-semibold">Comments (Optional)</label>
                                            <textarea class="form-control" id="comments{{ $vendor->id }}" name="comments" rows="3"
                    ...
                    <div class="col-12">
                        <div class="card shadow-sm border-0">
                            <div class="card-body text-center py-5">
                                ...
                                <p class="text-muted">There are no vendors with contracts in your department yet.</p>
                            </div>
                        </div>
                    </div>
                @endforelse
