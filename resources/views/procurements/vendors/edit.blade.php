                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('procurements.vendors.update', $vendor->id) }}" method="POST"
                                class="row g-3" enctype="multipart/form-data" id="vendorForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ old('name', $vendor->name) }}" placeholder="Enter vendor business name"
                                        required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        ...
                                        <option value="internal"
                                            {{ old('type', $vendor->type) == 'internal' ? 'selected' : '' }}>Internal
                                        </option>
                                        <option value="external"
                                            {{ old('type', $vendor->type) == 'external' ? 'selected' : '' }}>External
                                        </option>
                                        <option value="goods"
                                            {{ old('type', $vendor->type) == 'goods' ? 'selected' : '' }}>Goods Supplier
                                        </option>
                                        <option value="services"
                                            {{ old('type', $vendor->type) == 'services' ? 'selected' : '' }}>Service
                                            Provider</option>
                                        <option value="goods_and_services"
                                            {{ old('type', $vendor->type) == 'goods_and_services' ? 'selected' : '' }}>Goods
                                            & Services</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="owner_name" name="owner_name"
                                        ...
                                        placeholder="Enter owner/CEO full name">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="industry" name="industry">
                                        ...
                                        <option value="construction"
                                            {{ old('industry', $vendor->industry) == 'construction' ? 'selected' : '' }}>
                                            Construction & Civil Works</option>
                                        <option value="building_materials"
                                            {{ old('industry', $vendor->industry) == 'building_materials' ? 'selected' : '' }}>
                                            Building Materials & Supplies</option>
                                        <option value="it_equipment"
                                            {{ old('industry', $vendor->industry) == 'it_equipment' ? 'selected' : '' }}>IT
                                            Equipment & Hardware</option>
                                        <option value="office_supplies"
                                            {{ old('industry', $vendor->industry) == 'office_supplies' ? 'selected' : '' }}>
                                            Office Supplies & Stationery</option>
                                        <option value="furniture"
                                            {{ old('industry', $vendor->industry) == 'furniture' ? 'selected' : '' }}>
                                            Furniture & Fixtures</option>
                                        <option value="medical_supplies"
                                            {{ old('industry', $vendor->industry) == 'medical_supplies' ? 'selected' : '' }}>
                                            Medical Supplies & Equipment</option>
                                        <option value="consultancy"
                                            {{ old('industry', $vendor->industry) == 'consultancy' ? 'selected' : '' }}>
                                            Consultancy Services</option>
                                        <option value="legal"
                                            {{ old('industry', $vendor->industry) == 'legal' ? 'selected' : '' }}>Legal
                                            Services</option>
                                        <option value="transport"
                                            {{ old('industry', $vendor->industry) == 'transport' ? 'selected' : '' }}>
                                            Transport & Logistics</option>
                                        <option value="security_services"
                                            {{ old('industry', $vendor->industry) == 'security_services' ? 'selected' : '' }}>
                                            Security Services</option>
                                        <option value="cleaning_services"
                                            {{ old('industry', $vendor->industry) == 'cleaning_services' ? 'selected' : '' }}>
                                            Cleaning & Sanitation</option>
                                        <option value="catering"
                                            {{ old('industry', $vendor->industry) == 'catering' ? 'selected' : '' }}>
                                            Catering & Hospitality</option>
                                        <option value="training"
                                            {{ old('industry', $vendor->industry) == 'training' ? 'selected' : '' }}>
                                            Training
                                            & Capacity Building</option>
                                        <option value="other"
                                            {{ old('industry', $vendor->industry) == 'other' || (!in_array($vendor->industry, ['construction', 'building_materials', 'it_equipment', 'office_supplies', 'furniture', 'medical_supplies', 'consultancy', 'legal', 'transport', 'security_services', 'cleaning_services', 'catering', 'training']) && !empty($vendor->industry)) ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6" id="otherIndustryField"
                                    style="display: {{ old('industry', $vendor->industry) == 'other' || (!in_array($vendor->industry, ['construction', 'building_materials', 'it_equipment', 'office_supplies', 'furniture', 'medical_supplies', 'consultancy', 'legal', 'transport', 'security_services', 'cleaning_services', 'catering', 'training']) && !empty($vendor->industry)) ? 'block' : 'none' }};">
                                    ...
                                    <input type="text" class="form-control" id="other_industry_specify"
                                        name="other_industry_specify"
                                        value="{{ old('other_industry_specify', !in_array($vendor->industry, ['construction', 'building_materials', 'it_equipment', 'office_supplies', 'furniture', 'medical_supplies', 'consultancy', 'legal', 'transport', 'security_services', 'cleaning_services', 'catering', 'training']) && !empty($vendor->industry) ? $vendor->industry : '') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="active"
                                            {{ old('status', $vendor->status ?? 'active') == 'active' ? 'selected' : '' }}>
                                            Active</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="alternative_phone"
                                        ...
                                        value="{{ old('alternative_phone', $vendor->alternative_phone ?? '') }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="address" name="address" rows="3" placeholder="Full physical address">{{ old('address', $vendor->address) }}</textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="tax_number" name="tax_number"
                                        value="{{ old('tax_number', $vendor->tax_number) }}" placeholder="TIN number">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="number_of_employees" name="number_of_employees">
                                        ...
                                        <option value="1-10"
                                            {{ old('number_of_employees', $vendor->number_of_employees ?? '') == '1-10' ? 'selected' : '' }}>
                                            1-10 employees</option>
                                        <option value="11-50"
                                            {{ old('number_of_employees', $vendor->number_of_employees ?? '') == '11-50' ? 'selected' : '' }}>
                                            11-50 employees</option>
                                        <option value="51-100"
                                            {{ old('number_of_employees', $vendor->number_of_employees ?? '') == '51-100' ? 'selected' : '' }}>
                                            51-100 employees</option>
                                        <option value="101-500"
                                            {{ old('number_of_employees', $vendor->number_of_employees ?? '') == '101-500' ? 'selected' : '' }}>
                                            101-500 employees</option>
                                        <option value="500+"
                                            {{ old('number_of_employees', $vendor->number_of_employees ?? '') == '500+' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="country" name="country"
                                        value="{{ old('country', $vendor->country ?? 'Tanzania') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="bank_name" name="bank_name"
                                        value="{{ old('bank_name', $vendor->bank_name ?? '') }}" placeholder="Bank name">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="payment_terms" name="payment_terms">
                                        ...
                                        <option value="net_15"
                                            {{ old('payment_terms', $vendor->payment_terms ?? '') == 'net_15' ? 'selected' : '' }}>
                                            Net 15 days</option>
                                        <option value="net_30"
                                            {{ old('payment_terms', $vendor->payment_terms ?? '') == 'net_30' ? 'selected' : '' }}>
                                            Net 30 days</option>
                                        <option value="net_45"
                                            {{ old('payment_terms', $vendor->payment_terms ?? '') == 'net_45' ? 'selected' : '' }}>
                                            Net 45 days</option>
                                        <option value="net_60"
                                            {{ old('payment_terms', $vendor->payment_terms ?? '') == 'net_60' ? 'selected' : '' }}>
                                            Net 60 days</option>
                                        <option value="cash_on_delivery"
                                            {{ old('payment_terms', $vendor->payment_terms ?? '') == 'cash_on_delivery' ? 'selected' : '' }}>
                                            Cash on Delivery</option>
                                        <option value="advance"
                                            {{ old('payment_terms', $vendor->payment_terms ?? '') == 'advance' ? 'selected' : '' }}>
                                            Advance Payment</option>
                                        <option value="other"
                                            {{ old('payment_terms', $vendor->payment_terms ?? '') == 'other' ? 'selected' : '' }}>
                                            Other</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="currency" name="currency">
                                        <option value="TZS"
                                            {{ old('currency', $vendor->currency ?? 'TZS') == 'TZS' ? 'selected' : '' }}>
                                            TZS
                                            (Tanzanian Shilling)</option>
                                        <option value="USD"
                                            {{ old('currency', $vendor->currency ?? '') == 'USD' ? 'selected' : '' }}>USD
                                            (US Dollar)</option>
                                        <option value="EUR"
                                            {{ old('currency', $vendor->currency ?? '') == 'EUR' ? 'selected' : '' }}>EUR
                                            (Euro)</option>
                                    </select>
                                </div>
                                        ...
                                        <div class="list-group">
                                            @foreach ($existingAttachments as $index => $attachment)
                                                <div
                                                    ...
                                                    <div>
                                                        <i
                                                            class="fas fa-file-{{ isset($attachment['file_type']) && $attachment['file_type'] == 'pdf' ? 'pdf' : 'word' }} me-2"></i>
                                                        ...
                                                        @if (isset($attachment['original_name']) &&
                                                            ...
                                                            <br>
                                                            <small
                                                                class="text-muted">{{ $attachment['original_name'] }}</small>
                                                        @endif
                                                    </div>
                                ...
                                <div class="col-12 mb-3">
                                    <label for="documents" class="form-label fw-semibold">Upload Additional
                                        Documents</label>
                                ...
                                <div class="col-12">
                                    <div id="filePreview" class="mt-3">
                                        <p class="text-muted mb-2">No new files selected</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" rows="4"
                                        placeholder="Any additional information about this vendor...">{{ old('notes', $vendor->notes ?? '') }}</textarea>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                fileInput.addEventListener('change', function(e) {
                    ...
                    if (files.length === 0) {
                        if (filePreview.querySelectorAll('.file-preview-item').length === 0) {
                            filePreview.innerHTML = '<p class="text-muted mb-2">No new files selected</p>';
                        }
                        return;
                    }
            ...
            function addFileToPreview(file) {
                ...
                if (filePreview.innerHTML === '<p class="text-muted mb-2">No new files selected</p>') {
