            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Disclosure of Conflict of Interest</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-5">
            ...
            <div class="container">
                <div class="d-flex align-items-center justify-content-between">
                    <h2 class="my-4" style="margin: 0; font-size: 18px;">Step {{ session('current_step') }}: Disclosure of
                ...
                <small class="form-text text-muted">Please answer all questions truthfully. All fields marked with <span class="text-danger">*</span> are required.</small>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('conflict.store') }}" method="POST" id="conflictForm">
                                @csrf
                                @php
                                    $user = auth()->user();
                                @endphp
                                ...
                                <div class="form-group mt-3">
                                    <div class="form-check p-3" style="background-color: #f8f9fa; border-radius: 5px; border: 2px solid #e9ecef;">
                                        <input type="checkbox" name="hr_detail_declare" id="hr_detail_declare" 
                                            ...
                                            {{ old('hr_detail_declare', $user->hr_detail_declare) ? 'checked' : '' }}>
