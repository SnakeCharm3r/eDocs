            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header d-flex justify-content-between align-items-center">
                        <h3 class="page-title mb-0"><i class="fas fa-clipboard-check me-2"></i>Clearance Workflow Details</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>Form Type:</strong> 
                            <span class="badge bg-secondary"><i class="fas fa-clipboard-check me-1"></i>Clearance</span>
                        </p>
                    </div>
                    <div class="col-md-6">
                                ...
                                <div class="card border {{ !$pending->attendedBy || ($pending->attendedBy && $pending->attendedBy->status != 'active') ? 'border-danger' : 'border-warning' }}">
                                    <div class="card-body">
                                        ...
                                        @if($pending->attendedBy)
                                            ...
                                            @endif
                                            <div class="mt-3">
                                                <a href="{{ route('workflow-management.edit-clearance-history', $pending->id) }}" class="btn btn-warning btn-sm">
                                        ...
                                        @else
                                            <div class="alert alert-danger mb-0">
                                                ...
                                                <div class="mt-2">
                                                    <a href="{{ route('workflow-management.edit-clearance-history', $pending->id) }}" class="btn btn-danger btn-sm">
