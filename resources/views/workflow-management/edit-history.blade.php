...
<div class="page-wrapper">
    <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header d-flex justify-content-between align-items-center">
                        <h3 class="page-title mb-0"><i class="fas fa-edit me-2"></i>Edit Workflow History</h3>
                        <a href="{{ route('workflow-management.show', $history->work_flow_id) }}" class="btn btn-secondary btn-sm">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('workflow-management.update-history', $history->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('workflow-management.show', $history->work_flow_id) }}" class="btn btn-secondary">
                            Cancel
                        </a>
                    </div>
                </form>
