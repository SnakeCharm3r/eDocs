...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="pdf-like-container">
            ...
            <form action="{{ route('night-shift.store') }}" method="POST" id="ns-form" novalidate>
                @csrf
                        ...
                        <tr>
                            <td style="width:50%;">
                                ...
                                <select class="form-control" name="year" id="ns_year" required>
                                    ...
                                    <option value="{{ $y }}" {{ $y == $previousYear ? 'selected' : '' }}>{{ $y }}</option>
                                    @endfor
                                </select>
                            </td>
                            <td style="width:50%;">
                                ...
                                <select class="form-control" name="month" id="ns_month" required>
                                    @foreach($months as $m)
                                    <option value="{{ $m }}" {{ $m === $previousMonth ? 'selected' : '' }}>{{ $m }}</option>
                                    @endforeach
                                </select>
                            </td>
                        </tr>
                ...
                <button type="submit" class="btn btn-primary mt-2 js-submit-btn" id="submitBtn"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('ns-form').addEventListener('submit', function (e) {
        ...
        if (approvalError) {
            e.preventDefault();
            // Show error in the existing errors block or create one
            ...
            errBox.innerHTML = `<strong>Cannot submit:</strong> ${approvalError} <button type="button" class="btn-close" data-bs-dismiss="alert"></button>`;
