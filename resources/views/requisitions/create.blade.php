        ...
        <div class="content container-fluid">
            ...
            <div class="page-header mb-3">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title mb-1">Recruitment Requisition Form</h3>
                        @php
                            $currentUser = auth()->user();
                            $isHecMember =
                                $isHecMember ??
                                ($currentUser?->hasAnyRole(['coo', 'cms', 'cfo', 'crhdo', 'chief_accountant']) ??
                                    false);
                ...
                <div class="card shadow-sm mb-4" style="border-left: 4px solid #007A33;">
                    <div class="card-header bg-light border-bottom">
                        <h5 class="card-title mb-0" style="color: #333;">
                            <i class="fas fa-briefcase me-2" style="color: #007A33;"></i>Position Details
                        </h5>
                        <small class="text-muted">
                            @if ($isHecMember ?? false)
