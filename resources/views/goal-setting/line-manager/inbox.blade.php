        ...
        <div class="content container-fluid">
            <div class="page-header mb-4">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title mb-0">Line Manager Inbox</h3>
                        <small class="text-muted">Goals awaiting your review/approval</small>
                    </div>
                    <div class="col-auto">
                        <a href="{{ route('goal-setting.staff.my-goals') }}" class="btn btn-secondary btn-sm">My Goals</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-body">
                    <form method="GET" action="{{ route('goal-setting.line-manager.inbox') }}" class="row g-2 align-items-end">
                        <div class="col-md-4">
                            ...
                            <tbody>
                                @forelse ($goals as $i => $goal)
                                    <tr>
                                        ...
                                        <td>{{ $goal->owner->display_name ?? ($goal->owner->username ?? '—') }}</td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <form method="POST" action="{{ route('goal-setting.goals.submit-hec', $goal->id) }}" style="display:inline-block;">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-outline-primary">Submit to HEC</button>
                                            </form>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted py-4">No goals pending your action.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
